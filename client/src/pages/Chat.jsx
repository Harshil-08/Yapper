        ...
        {messages.length === 0 ? (
          ...
          messages.map((msg, index) => (
            <div key={index} className={`flex items-start gap-2 ${msg.sender?._id === user?._id ? "justify-end" : ""}`}>
              ...
              <div
                className={`p-2 rounded-lg break-words whitespace-pre-wrap max-w-[80%] ${
                  msg.sender?._id === user?._id
                    ? "bg-teal-100 dark:bg-teal-900/30 text-left"
              ...
              >
                ...
                <p className="text-teal-900 dark:text-white">{msg.content}</p>
              </div>
